...
public class DiscussionNewPostViewController: UIViewController, UITextViewDelegate, MenuOptionsViewControllerDelegate, InterfaceOrientationOverriding {
    ...
    override public func viewWillAppear(_ animated: Bool) {
        ...
        self.environment.analytics.trackDiscussionScreen(withName: OEXAnalyticsScreenCreateTopicThread, courseId: self.courseID, value: selectedTopic?.name, threadId: nil, topicId: selectedTopic?.id, responseID: nil, author: nil)
    }
