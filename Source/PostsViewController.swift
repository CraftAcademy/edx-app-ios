...
class PostsViewController: UIViewController, UITableViewDataSource, UITableViewDelegate, PullRefreshControllerDelegate, InterfaceOrientationOverriding, DiscussionNewPostViewControllerDelegate {
    ...
    private func logScreenEvent() {
        ...
        case let .Topic(topic):
            self.environment.analytics.trackDiscussionScreen(withName: OEXAnalyticsScreenViewTopicThreads, courseId: self.courseID, value: topic.name, threadId: nil, topicId: topic.id, responseID: nil, author: nil)
        ...
        case .Following:
            self.environment.analytics.trackDiscussionScreen(withName: OEXAnalyticsScreenViewTopicThreads, courseId: self.courseID, value: "posts_following", threadId: nil, topicId: "posts_following", responseID: nil, author: nil)
        case .AllPosts:
            self.environment.analytics.trackDiscussionScreen(withName: OEXAnalyticsScreenViewTopicThreads, courseId: self.courseID, value: "all_posts", threadId: nil, topicId: "all_posts", responseID: nil, author: nil)
        }
    }
